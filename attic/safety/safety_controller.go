...
// Archived: inference safety fallback (pruned — providers-based budget fallback not in wedge).
// Core durable execution uses coordinator + api proof, not this controller.
