...
// RateLimiterConfig holds rate limiting configuration for OpenAI
type RateLimiterConfig struct {
	RequestsPerMinute int           // Max requests per minute (e.g., 60 for GPT-3.5, 90 for GPT-4)
	TokensPerMinute   int           // Max tokens per minute (e.g., 90000 for GPT-3.5, 150000 for GPT-4)
...
// DefaultRateLimiterConfig returns sensible defaults for OpenAI
// These defaults are conservative to work with Tier 1 limits
func DefaultRateLimiterConfig() *RateLimiterConfig {
	return &RateLimiterConfig{
		RequestsPerMinute: 60,     // Conservative for GPT-3.5/GPT-4 Tier 1
		TokensPerMinute:   90000,  // Conservative for GPT-3.5 Tier 1
